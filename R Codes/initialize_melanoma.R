...
initialize_pop_mel <- function(pop_size, nsim,
                           ...
                           incsource, mortsource) 
{
  ...
  inc <- interpolate_cumsurv_mel(incidence_mel, 
                             ratevar='Rate.Per.100K',
                             country=incsource,
                             maxage=maxIncAge)
  mort <- interpolate_cumsurv_mel(othercausemort, 
                              ratevar='Rate.Per.100K',
                              country=mortsource)
  # Code compatibility tweaks
  mort <- transform(mort, Age=age, Survival=cumsurv)
